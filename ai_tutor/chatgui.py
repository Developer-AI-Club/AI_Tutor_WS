...
def send():
    ...
    if msg != '':
        ...
        chat_window.config(foreground="#2B8888", font=("Verdana", 12 ))
...
SendButton = Button(window, font=("Verdana",12,'bold'), text="Send", width="12", height=5,
                    bd=0, bg="#2B8888", activebackground="#3c9d9b",fg='#ffffff',
                    command=send)

#Create the box to enter message
chat_box = Text(frame, bd=0, bg="#D0E7E7",width="29", height="5", font="Arial")
...
chat_box.place(x=6, y=401, height=90, width=665)
SendButton.place(x=660, y=401, height=90, width=120)
